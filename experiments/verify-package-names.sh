...
official_names=(vlc shortwave gst-plugins-base gst-plugins-good gst-plugins-bad gst-plugins-ugly gst-libav gst-plugin-pipewire vlc-plugins-all libdvdcss handbrake easytag)
